...
if __name__ == '__main__':      
    print(input_string('Ingrese string (mayor de 10 caracteres): ',min=10))
    print(input_string('Ingrese string (menor de 10 caracteres): ',max=10))
    print(input_string('Ingrese string (menor de 10 caracteres y mayor a 5): ',max=10,min=5))
